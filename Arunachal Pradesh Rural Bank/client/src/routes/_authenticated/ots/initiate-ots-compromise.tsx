...
const FormSchema = z.object({
  ...
  // ===========================
  // Annexure-IV (extra fields)
  // ===========================
  annexureIVAddress: z.string().optional(),
  annexureIVPanNumber: z.string().optional(),
  annexureIVAadhaarNumber: z.string().optional(),
  annexureIVAccountCategoryAsOnDate: z.string().optional(), // e.g., AUCA
  annexureIVAccruedInterest: z.string().optional(),
  annexureIVUri: z.string().optional(),

  // ===========================
  // Annexure-V (extra fields)
  // ===========================
  annexureVAddress: z.string().optional(),
  annexureVPanNumber: z.string().optional(),
  annexureVAadhaarNumber: z.string().optional(),
  annexureVAccountCategoryAsOnDate: z.string().optional(),
  annexureVAccruedInterest: z.string().optional(),
  annexureVUri: z.string().optional(),
})
...
function RouteComponent() {
  ...
  const createOTSMutation = $api.useMutation('post', '/otsproposal/create', {
    onSuccess: () => {
      ...
      form.reset({
        ...
        annexureIVAddress: '',
        annexureIVPanNumber: '',
        annexureIVAadhaarNumber: '',
        annexureIVAccountCategoryAsOnDate: '',
        annexureIVAccruedInterest: '',
        annexureIVUri: '',

        annexureVAddress: '',
        annexureVPanNumber: '',
        annexureVAadhaarNumber: '',
        annexureVAccountCategoryAsOnDate: '',
        annexureVAccruedInterest: '',
        annexureVUri: '',
      })
      ...
      },
      {
        onSuccess: (res) => {
          ...
          form.reset({
            ...
            // Annexure-IV (extra)
            annexureIVAddress: addr,
            annexureIVPanNumber: '',
            annexureIVAadhaarNumber: '',
            annexureIVAccountCategoryAsOnDate: '',
            annexureIVAccruedInterest: bestAccrued,
            annexureIVUri: '',

            // Annexure-V (extra)
            annexureVAddress: addr,
            annexureVPanNumber: '',
            annexureVAadhaarNumber: '',
            annexureVAccountCategoryAsOnDate: '',
            annexureVAccruedInterest: bestAccrued,
            annexureVUri: '',
          })
  ...
  const onSubmit = (values: FormValues) => {
    ...
    //     branchName: values.branchName || undefined,
    //     borrowerName: values.borrowerName || undefined,
    //     address: values.annexureIVAddress || undefined,
    //     loanAccountNo: values.loanAccountNo || undefined,
    //     panNumber: values.annexureIVPanNumber || undefined,
    //     aadhaarNumber: values.annexureIVAadhaarNumber || undefined,
    //     npaDate: values.npaDate || undefined,

    //     assetCategoryToday: values.assetCategoryToday || undefined,
    //     accountCategoryAsOnDate:
    //       values.annexureIVAccountCategoryAsOnDate || undefined,

    //     outstandingT1: toNumberOrUndefined(values.outstandingT1),
    //     accruedInterest: toNumberOrUndefined(values.annexureIVAccruedInterest),
    //     uri: values.annexureIVUri || undefined,
    //     legalCharges: toNumberOrUndefined(values.legalCharges),

    //     totalDues: totalDuesNumber,
    //     otsOfferedAmount: toNumberOrUndefined(values.otsOfferedAmount),
    //     sacrificeAmount: totalLossNumber,
    //   },
    // }
    ...
    //     branchName: values.branchName || undefined,
    //     borrowerName: values.borrowerName || undefined,
    //     address: values.annexureVAddress || undefined,
    //     loanAccountNo: values.loanAccountNo || undefined,
    //     panNumber: values.annexureVPanNumber || undefined,
    //     aadhaarNumber: values.annexureVAadhaarNumber || undefined,
    //     npaDate: values.npaDate || undefined,

    //     assetCategoryToday: values.assetCategoryToday || undefined,
    //     accountCategoryAsOnDate:
    //       values.annexureVAccountCategoryAsOnDate || undefined,

    //     outstandingT1: toNumberOrUndefined(values.outstandingT1),
    //     accruedInterest: toNumberOrUndefined(values.annexureVAccruedInterest),
    //     uri: values.annexureVUri || undefined,
    //     legalCharges: toNumberOrUndefined(values.legalCharges),
    ...
    createOTSMutation.mutate({
      ...
      body: {
        ...
        // ✅ New annexure payloads (same API, additional data)
        // annexureIV,
        // annexureV,
      },
    })
  ...
  return (
    <>
      ...
      <div className='p-4'>
        ...
        <Card className='mt-6'>
          <CardHeader>
            <CardTitle>Annexure-IV</CardTitle>
            <CardDescription>
              Details for Annexure-IV (auto-mapped from Annexure-III +
              additional fields).
            </CardDescription>
          </CardHeader>

          <CardContent className='space-y-5'>
            <RowField no='1' label='Branch Name' htmlFor='annexureIV_branch'>
              <Input
                id='annexureIV_branch'
            ...
            <RowField
              no='2'
              label='Borrower Name'
              htmlFor='annexureIV_borrower'
            >
              <Input
                id='annexureIV_borrower'
            ...
            <RowField no='3' label='Address' htmlFor='annexureIVAddress'>
              <Textarea
                id='annexureIVAddress'
                placeholder='Full address...'
                {...form.register('annexureIVAddress')}
              />
            </RowField>
            ...
            <RowField
              ...
              htmlFor='annexureIV_loanAccountNo'
            >
              <Input
                id='annexureIV_loanAccountNo'
                value={form.watch('loanAccountNo') ?? ''}
                readOnly
                disabled
              />
            </RowField>

            <RowField no='5' label='PAN Number' htmlFor='annexureIVPanNumber'>
              <Input
                id='annexureIVPanNumber'
                placeholder='ABCDE1234F'
                {...form.register('annexureIVPanNumber')}
              />
            </RowField>
            ...
            <RowField
              ...
              htmlFor='annexureIVAadhaarNumber'
            >
              <Input
                id='annexureIVAadhaarNumber'
                inputMode='numeric'
                placeholder='123412341234'
                {...form.register('annexureIVAadhaarNumber')}
              />
            </RowField>

            <RowField no='7' label='NPA Date' htmlFor='annexureIV_npaDate'>
              <Input
                id='annexureIV_npaDate'
                type='date'
                value={form.watch('npaDate') ?? ''}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='8'
              label='Asset Category Today'
              htmlFor='annexureIV_assetCategoryToday'
            >
              <Input
                id='annexureIV_assetCategoryToday'
                value={form.watch('assetCategoryToday') ?? ''}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='9'
              label='Account Category As On Date'
              htmlFor='annexureIVAccountCategoryAsOnDate'
              rightNote='e.g., AUCA'
            >
              <Input
                id='annexureIVAccountCategoryAsOnDate'
                placeholder='AUCA'
                {...form.register('annexureIVAccountCategoryAsOnDate')}
              />
            </RowField>
            ...
            <RowField
              no='10'
              label='Outstanding (₹)'
              htmlFor='annexureIV_outstanding'
            >
              <Input
                id='annexureIV_outstanding'
                value={formatMoney(toNumber(form.watch('outstandingT1')))}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              ...
              htmlFor='annexureIVAccruedInterest'
            >
              <Input
                id='annexureIVAccruedInterest'
                inputMode='decimal'
                placeholder='0'
                {...form.register('annexureIVAccruedInterest')}
              />
            </RowField>

            <RowField no='12' label='URI' htmlFor='annexureIVUri'>
              <Input
                id='annexureIVUri'
                placeholder='URI-REF-001'
                {...form.register('annexureIVUri')}
              />
            </RowField>
            ...
            <RowField
              no='13'
              label='Legal Charges (₹)'
              htmlFor='annexureIV_legalCharges'
            >
              <Input
                id='annexureIV_legalCharges'
                value={formatMoney(toNumber(form.watch('legalCharges')))}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='14'
              label='Total Dues (₹)'
              htmlFor='annexureIV_totalDues'
            >
              <Input
                id='annexureIV_totalDues'
                value={formatMoney(totalDues)}
                readOnly
                disabled
              />
            ...
            <RowField
              no='15'
              label='OTS Offered Amount (₹)'
              htmlFor='annexureIV_otsOffered'
            >
              <Input
                id='annexureIV_otsOffered'
                value={formatMoney(toNumber(form.watch('otsOfferedAmount')))}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='16'
              label='Sacrifice Amount (₹)'
              htmlFor='annexureIV_sacrifice'
              rightNote='(Total Dues - OTS Offered Amount)'
            >
              <Input
                id='annexureIV_sacrifice'
                value={formatMoney(totalLoss)}
                readOnly
                disabled
              />
        ...
        <Card className='mt-6'>
          <CardHeader>
            <CardTitle>Annexure-V</CardTitle>
            <CardDescription>
              Details for Annexure-V (auto-mapped from Annexure-III + additional
              fields).
            </CardDescription>
          </CardHeader>

          <CardContent className='space-y-5'>
            <RowField no='1' label='Branch Name' htmlFor='annexureV_branch'>
              <Input
                id='annexureV_branch'
                value={form.watch('branchName') ?? ''}
                readOnly
            ...
            <RowField no='2' label='Borrower Name' htmlFor='annexureV_borrower'>
              <Input
                id='annexureV_borrower'
                value={form.watch('borrowerName') ?? ''}
                readOnly
                disabled
              />
            ...
            <RowField no='3' label='Address' htmlFor='annexureVAddress'>
              <Textarea
                id='annexureVAddress'
                placeholder='Full address...'
                {...form.register('annexureVAddress')}
              />
            </RowField>
            ...
            <RowField
              no='4'
              label='Loan Account No'
              htmlFor='annexureV_loanAccountNo'
            >
              <Input
                id='annexureV_loanAccountNo'
                value={form.watch('loanAccountNo') ?? ''}
                readOnly
                disabled
              />
            ...
            <RowField no='5' label='PAN Number' htmlFor='annexureVPanNumber'>
              <Input
                id='annexureVPanNumber'
                placeholder='ABCDE1234F'
                {...form.register('annexureVPanNumber')}
              />
            </RowField>
            ...
            <RowField
              no='6'
              label='Aadhaar Number'
              htmlFor='annexureVAadhaarNumber'
            >
              <Input
                id='annexureVAadhaarNumber'
                inputMode='numeric'
                placeholder='123412341234'
                {...form.register('annexureVAadhaarNumber')}
              />
            </RowField>

            <RowField no='7' label='NPA Date' htmlFor='annexureV_npaDate'>
              <Input
                id='annexureV_npaDate'
                type='date'
                value={form.watch('npaDate') ?? ''}
                readOnly
                disabled
            ...
            <RowField
              no='8'
              label='Asset Category Today'
              htmlFor='annexureV_assetCategoryToday'
            >
              <Input
                id='annexureV_assetCategoryToday'
                value={form.watch('assetCategoryToday') ?? ''}
                readOnly
                disabled
              />
            ...
            <RowField
              no='9'
              label='Account Category As On Date'
              htmlFor='annexureVAccountCategoryAsOnDate'
              rightNote='e.g., AUCA'
            >
              <Input
                id='annexureVAccountCategoryAsOnDate'
                placeholder='AUCA'
                {...form.register('annexureVAccountCategoryAsOnDate')}
              />
            </RowField>
            ...
            <RowField
              no='10'
              label='Outstanding (₹)'
              htmlFor='annexureV_outstanding'
            >
              <Input
                id='annexureV_outstanding'
                value={formatMoney(toNumber(form.watch('outstandingT1')))}
                readOnly
                disabled
              />
            ...
            <RowField
              no='11'
              label='Accrued Interest (₹)'
              htmlFor='annexureVAccruedInterest'
            >
              <Input
                id='annexureVAccruedInterest'
                inputMode='decimal'
                placeholder='0'
                {...form.register('annexureVAccruedInterest')}
              />
            </RowField>

            <RowField no='12' label='URI' htmlFor='annexureVUri'>
              <Input
                id='annexureVUri'
                placeholder='URI-REF-001'
                {...form.register('annexureVUri')}
              />
            </RowField>
            ...
            <RowField
              no='13'
              label='Legal Charges (₹)'
              htmlFor='annexureV_legalCharges'
            >
              <Input
                id='annexureV_legalCharges'
                value={formatMoney(toNumber(form.watch('legalCharges')))}
                readOnly
                disabled
              />
            ...
            <RowField
              no='14'
              label='Total Dues (₹)'
              htmlFor='annexureV_totalDues'
            >
              <Input
                id='annexureV_totalDues'
                value={formatMoney(totalDues)}
                readOnly
                disabled
              />
            ...
            <RowField
              no='15'
              label='OTS Offered Amount (₹)'
              htmlFor='annexureV_otsOffered'
            >
              <Input
                id='annexureV_otsOffered'
                value={formatMoney(toNumber(form.watch('otsOfferedAmount')))}
                readOnly
                disabled
              />
            ...
            <RowField
              no='16'
              label='Sacrifice Amount (₹)'
              htmlFor='annexureV_sacrifice'
              rightNote='(Total Dues - OTS Offered Amount)'
            >
              <Input
                id='annexureV_sacrifice'
                value={formatMoney(totalLoss)}
                readOnly
                disabled
              />
                ...
                onClick={() => {
                  if (accountDetails || branchDeptInfo) {
                    form.reset({
                      ...
                      // Annexure-IV (clear manual)
                      annexureIVPanNumber: '',
                      annexureIVAadhaarNumber: '',
                      annexureIVAccountCategoryAsOnDate: '',
                      annexureIVUri: '',

                      // Annexure-V (clear manual)
                      annexureVPanNumber: '',
                      annexureVAadhaarNumber: '',
                      annexureVAccountCategoryAsOnDate: '',
                      annexureVUri: '',
