...
// --- Route Definition ---
export const Route = createFileRoute('/_authenticated/sarfaesi/tasks/')({
  ...
  return (
    <MainWrapper>
      <div className='bg-muted/10 flex h-full flex-col space-y-2 p-2'>
        ...
        <div className='grid gap-6 md:grid-cols-7 lg:grid-cols-7 mt-4'>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className='sm:max-w-[500px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete the actions required for this SARFAESI stage.
          </DialogDescription>
        </DialogHeader>
