...
function RouteComponent() {
  ...
  const submitReportMutation = $api.useMutation('post', '/api/stock-audits/ugb', {
    onSuccess: () => {
        ...
        <Form {...form}>
          ...
          >
            ...
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b flex flex-col gap-1'>
                ...
                <p className='text-xs text-muted-foreground'>
                  Capture Fund Based / Non-Fund Based facilities with limits, securities, DP, O/s, Overdues & ROI.
                </p>
              </CardHeader>
                ...
                <EditableTable
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      type: 'text',
                      placeholder: 'Working Capital / Export Credit / Term Loan / Guarantee etc.',
                    },
                    {
                      key: 'limitSanctioned',
            ...
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  Inspection at Branch – Terms & Conditions / Documentation (Annexure II C – A & Docs)
                </CardTitle>
              </CardHeader>
              <CardContent className='pt-6 space-y-6'>
                {/* Terms & Conditions */}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Any Other Irregularities Observed in Documentation</FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
                      <FormMessage />
              ...
              <CardContent className='pt-6 space-y-6'>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Whether Account is Regularly / Actively Operated</FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                        <FormMessage />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Whether Excesses Reported to Higher Authority</FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder='e.g. Cost or NRV, whichever is lower' {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
