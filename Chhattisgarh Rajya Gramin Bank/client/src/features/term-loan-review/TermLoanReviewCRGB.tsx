...
// BankCode: CRGB  (Schema = A)
// Uses SAME APIs as reference:
//  - GET    /term-loan-review/get?bankCode=CRGB&acctNo=...
//  - POST   /term-loan-review/create/review?bankCode=CRGB
//  - PUT    /term-loan-review/update/review/{reviewId}?bankCode=CRGB
//  - DELETE /term-loan-review/delete/review/{reviewId}?bankCode=CRGB
// ------------------------------------------------------------------
...
export default function CRGBLoanReviewForm() {
  ...
  const {
    ...
    params: {
      query: { bankCode: 'CRGB', acctNo: accountId ?? '' },
    },
  })
  ...
  const confirmDelete = async () => {
    ...
    try {
      await deleteMutation.mutateAsync({
        params: { query: { bankCode: 'CRGB' }, path: { reviewId: deleteId } },
      })
                ...
                >
                  ...
                  <div className='mt-4 grid grid-cols-1 gap-4 md:grid-cols-3'>
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>CRGB Sanction For</FormLabel>
                          <FormControl>
                            <Input {...field} />
                          </FormControl>
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>CRGB Approval For</FormLabel>
                          <FormControl>
                            <Input {...field} />
                          </FormControl>
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>CRGB Confirm For</FormLabel>
                          <FormControl>
                            <Input {...field} />
                          </FormControl>
                        </FormItem>
