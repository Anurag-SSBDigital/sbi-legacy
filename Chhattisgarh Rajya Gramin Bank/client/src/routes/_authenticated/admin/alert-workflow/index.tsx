...
function RouteComponent() {
  const canCreateWorkflow = useCanAccess('alert_workflow', 'create')
  const canUpdateWorkflow = useCanAccess('alert_workflow', 'update')
        ...
        <div className='mx-auto max-w-7xl'>
          ...
          <header className='mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
            ...
            <Dialog
              open={openCreate}
              onOpenChange={(open) => {
                if (open && !canCreateWorkflow) return
                setOpenCreate(open)
                if (!open) reset() // clear form when closing
              }}
            >
              <DialogTrigger asChild>
                <Button size='sm' disabled={!canCreateWorkflow}>
                  Create Workflow
                </Button>
              </DialogTrigger>
                ...
                <form onSubmit={onSubmit} className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value='EWS'>EWS (Legacy)</SelectItem>
          ...
          <div className='mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
            <div className='flex items-center gap-4'>
              ...
              >
                <ToggleGroupItem value='EWS'>EWS (Legacy)</ToggleGroupItem>
      ...
      >
        <DialogContent className='sm:max-w-md'>
          ...
          <DialogFooter>
            ...
            <Button
              disabled={
                !canUpdateWorkflow || activateWorkflowMutation.isPending
              }
              onClick={() =>
