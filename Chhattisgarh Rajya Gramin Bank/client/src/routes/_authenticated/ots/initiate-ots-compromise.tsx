...
const FormSchema = z.object({
  ...
  // =============================
  // Annexure-I (new section fields)
  // =============================
  tgbApplicationDeadline: z.string().optional(),
  tgbFinalPaymentDeadline: z.string().optional(),

  // =============================
  // Annexure-IV (new section fields)
  // =============================
  resolutionApplicationDate: z.string().optional(),
})
...
function RouteComponent() {
  ...
  const form = useForm<FormValues>({
    defaultValues: {
      branchManagerUndertaking: 'NO',
      tgbApplicationDeadline: '',
      tgbFinalPaymentDeadline: '',
      resolutionApplicationDate: '',
    },
  })
  ...
  const onSubmit = (values: FormValues) => {
    if (!canCreateProposal) {
      toast.error('You do not have permission to create OTS proposals.')
      return
    }
    ...
    // ✅ API remains EXACTLY as your reference code (no new payload keys)
    createOTSMutation.mutate({
      params: { header: { Authorization: '' } },
      body: {
        bankFormat: 'TGB',
      ...
      <div className='p-4'>
        ...
        <Card className='mb-6'>
          <CardHeader>
            ...
            <CardDescription>
              Deadlines / timeline information (Annexure-I).
            </CardDescription>
          </CardHeader>

          <CardContent className='space-y-5'>
            <RowField no='1' label='Bank Format' htmlFor='annexureI_bankFormat'>
              <Input id='annexureI_bankFormat' value='TGB' readOnly disabled />
            </RowField>

            <RowField no='2' label='Branch Name' htmlFor='annexureI_branchName'>
              <Input
                id='annexureI_branchName'
            ...
            <RowField
              no='3'
              label='Borrower Name'
              htmlFor='annexureI_borrowerName'
            >
              <Input
                id='annexureI_borrowerName'
            ...
            <RowField
              ...
              htmlFor='tgbApplicationDeadline'
            >
              <Input
                id='tgbApplicationDeadline'
                type='date'
                {...form.register('tgbApplicationDeadline')}
              />
            </RowField>
            ...
            <RowField
              ...
              htmlFor='tgbFinalPaymentDeadline'
            >
              <Input
                id='tgbFinalPaymentDeadline'
                type='date'
                {...form.register('tgbFinalPaymentDeadline')}
              />
            </RowField>
          </CardContent>
        </Card>
        ...
        {/* ==========================
            Annexure-III (EXISTING - unchanged UI)
        ========================== */}
        <Card>
          <CardHeader>
            <CardTitle>Annexure-III</CardTitle>
          ...
          <CardContent className='space-y-5'>
            <RowField no='1' label='Regional Office' htmlFor='regionalOffice'>
              <Input
                id='regionalOffice'
                placeholder='Regional Office'
                {...form.register('regionalOffice')}
        ...
        <Card className='mt-6'>
          <CardHeader>
            ...
            <CardDescription>
              Resolution / application date and payment schedule (Annexure-IV).
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className='space-y-5'>
            <RowField
              no='1'
              label='Bank Format'
              htmlFor='annexureIV_bankFormat'
            >
              <Input id='annexureIV_bankFormat' value='TGB' readOnly disabled />
            </RowField>

            <RowField
              no='2'
              label='Branch Name'
              htmlFor='annexureIV_branchName'
            >
              <Input
                id='annexureIV_branchName'
                value={form.watch('branchName') ?? ''}
                readOnly
                disabled
              />
            ...
            <RowField
              no='3'
              label='Borrower Name'
              htmlFor='annexureIV_borrowerName'
            >
              <Input
                id='annexureIV_borrowerName'
                value={form.watch('borrowerName') ?? ''}
                readOnly
                disabled
              />
            ...
            <RowField
              no='4'
              label='Resolution / Application Date'
              htmlFor='resolutionApplicationDate'
            >
              <Input
                id='resolutionApplicationDate'
                type='date'
                {...form.register('resolutionApplicationDate')}
              />
            </RowField>
            ...
            <RowField
              no='6'
              label='25% Paid Date'
              htmlFor='annexureIV_otsPaid25Date'
            >
              <Input
                id='annexureIV_otsPaid25Date'
                value={form.watch('otsPaid25Date') ?? ''}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='7'
              label='25% Paid Amount (₹)'
              htmlFor='annexureIV_otsPaid25Amount'
            >
              <Input
                id='annexureIV_otsPaid25Amount'
                value={formatMoney(toNumber(form.watch('otsPaid25Amount')))}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='8'
              label='75% Due Date'
              htmlFor='annexureIV_otsDue75Date'
            >
              <Input
                id='annexureIV_otsDue75Date'
                value={form.watch('otsDue75Date') ?? ''}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              no='9'
              label='75% Due Amount (₹)'
              htmlFor='annexureIV_otsDue75Amount'
            >
              <Input
                id='annexureIV_otsDue75Amount'
                value={formatMoney(toNumber(form.watch('otsDue75Amount')))}
                readOnly
                disabled
              />
            </RowField>
            ...
            <RowField
              ...
              htmlFor='annexureIV_otsOfferedAmount'
            >
              <Input
                id='annexureIV_otsOfferedAmount'
          ...
          <CardFooter className='justify-end'>
            <div className='flex gap-2'>
              ...
              <Button
                onClick={form.handleSubmit(onSubmit)}
                className='text-white'
                disabled={isSaving || !canCreateProposal}
              >
                {isSaving ? 'Submitting…' : 'Submit'}
              </Button>
            </div>
