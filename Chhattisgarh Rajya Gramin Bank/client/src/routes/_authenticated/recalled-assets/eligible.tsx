...
export const Route = createFileRoute(
  '/_authenticated/recalled-assets/eligible'
)({
...
function RouteComponent() {
  ...
  const canInitiate = useCanAccess('recalled_assets', 'initiate')
  ...
  const initiateRecalledAssetMutation = $api.useMutation(
    'post',
    '/api/recalledassets/{accountNumber}/initiate'
  )
    ...
    <>
      ...
      <Main className='px-4 py-2'>
        <AppBreadcrumb
          ...
          currentPage={{
            type: 'label',
            label: 'Recalled Asset Eligible Accounts',
          }}
        />
        ...
        {isLoading ? (
          ...
          <div className='py-10 text-center text-red-500'>
            Error fetching eligible Recalled Asset accounts:{' '}
            {String((error as Error).message)}
          </div>
        ) : !accounts || accounts.length === 0 ? (
          <div className='py-10 text-center text-gray-500'>
            No Recalled Asset eligible accounts available.
          </div>
        ) : (
            ...
            <CardHeader className='flex flex-col gap-4 sm:flex-row sm:items-baseline sm:justify-between'>
              <div>
                <CardTitle className='text-2xl font-bold text-gray-800 dark:text-gray-200'>
                  Recalled Asset Eligible Accounts ({filteredData.length}{' '}
                  accounts)
                </CardTitle>
            ...
            <CardContent className='px-6'>
              <PaginatedTable
                ...
                renderActions={(row) => {
                  ...
                  const completed =
                    row.proposalCreated === true &&
                    row.workflowInitiated === true
                  ...
                  return (
                    <div className='flex flex-row justify-end gap-1'>
                      ...
                      {!row.proposalCreated && canCreateProposal && (
                        <Link
                          to='/recalled-assets/proposal/$accountNumber'
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action will initiate the Recalled Asset process for account{' '}
                      ...
                      <div className='grid gap-3 text-xs sm:grid-cols-2'>
                        ...
                        <div className='bg-background/60 rounded-lg border p-3'>
                          ...
                          <p className='text-muted-foreground mt-1 text-xs'>
                            Sanction:{' '}
                            {(
                              accountDetails.loanSanctionAmount ?? 0
                            ).toLocaleString('en-IN', {
                              maximumFractionDigits: 2,
                            })}
                          </p>
                        ...
                        <div className='bg-background/60 rounded-lg border p-3'>
                          ...
                          <p className='mt-1 text-xs'>
                            Sanction Date:{' '}
                            {accountDetails.loanSanctionDate ?? '-'}
                          </p>
                          <p className='mt-1 text-xs'>
                            Proposal For: {accountDetails.proposalFor ?? '-'}
                          </p>
                          <p className='mt-1 text-xs'>
                            Authority:{' '}
                            {accountDetails.sanctioningAuthority ?? '-'}
                          </p>
                        </div>
