...
function RouteComponent() {
  ...
  const canUploadDocument = useCanAccess('sarfaesi', 'upload_document')
  const canCompleteByPermission = useCanAccess('sarfaesi', 'complete_task')
  const canDownloadDocument = useCanAccess('sarfaesi', 'download_document')
  ...
  const downloadStagePdf = useCallback(
    ...
    [accountNumber, canDownloadDocument]
  )
