...
export const Route = createFileRoute(
  '/_authenticated/stock-audit/$accountId/report/$assignmentIdACRB'
)({
  component: RouteComponent,
})

function RouteComponent() {
  const { accountId, assignmentIdACRB } = Route.useParams()
  ...
  const { data: borrowerDetail, isLoading: isLoadingBorrower } = $api.useQuery(
    ...
    {
      params: {
        query: { acctNm: accountId, assignId: Number(assignmentIdACRB) },
      },
    }
  )
  ...
  const submitReportMutation = $api.useMutation(
    'post',
    '/api/acrb-stock-audit/create',
    {
      onSuccess: () => {
        toast.success('Stock Audit Report (ACRB) submitted successfully')
        navigate({
  ...
  const onSubmit = (data) => {
    submitReportMutation.mutate({
      body: {
        ...
        bankCode: 'ACRB',
        accountId,
        assignmentId: Number(assignmentIdACRB),
      },
    })
  }
        ...
        <Form {...form}>
          ...
          >
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Name of the CA Firm / Stock Auditor
                        </FormLabel>
                        <FormControl>
            ...
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='flex flex-col gap-1 border-b'>
                ...
                <p className='text-muted-foreground text-xs'>
                  ...
                  securities, DP, outstanding, overdues & ROI.
                </p>
              </CardHeader>
            ...
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  III. Inspection at Branch – Terms & Conditions / Documentation
            ...
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  VIII. Other Features, Statutory Compliance & Overall
                  Observations
                </CardTitle>
              </CardHeader>
              <CardContent className='space-y-6 pt-6'>
            ...
            {/* ===================== Sticky Actions ===================== */}
            <div className='supports-[backdrop-filter]:bg-background/60 bg-background/80 sticky bottom-0 z-10 -mx-6 border-t px-6 py-4 backdrop-blur'>
