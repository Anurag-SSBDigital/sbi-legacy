      ...
      <Form {...form}>
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6 pb-32'>
          ...
          <header className='from-primary/20 via-primary/10 ring-border mb-8 flex items-center justify-between rounded-2xl bg-gradient-to-r to-transparent p-6 ring-1'>
            <div>
              <h1 className='text-xl font-semibold'>Annual Stock Audit</h1>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className='text-muted-foreground text-xs'>
                Basic details of the borrower and facility as per MRB stock
                audit format.
              </CardDescription>
            </CardHeader>
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Borrower&apos;s Constitution (Proprietorship /
                        Partnership / Company)
                      </FormLabel>
                      <FormControl>
                        <Input {...field} />
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Date of Sanction &amp; Sanctioning Authority
                      </FormLabel>
                      <FormControl>
                        <Input
                          placeholder='e.g. 15-03-2024 – GM (Credit)'
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder='e.g. Fund-based CC limit'
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder='e.g. 10-07-2025 to 12-07-2025'
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Obsolete / Non-moving stock identified?
                      </FormLabel>
                      <FormControl>
                        <YesNoNaSelect
                          name={field.name}
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Other bank relationships / facilities
                      </FormLabel>
                      <FormControl>
                        <select
                          name={field.name}
            ...
            <CardContent className='space-y-2'>
              {[
                ...
                },
                {
                  ...
                  label:
                    'Debtors aging incorrect / overdue debtors included in DP.',
                },
                {
                ...
                },
                {
                  ...
                  label:
                    'Material misstatement in Insurance location/coverage.',
                },
                {
            ...
            <CardContent className='space-y-4'>
              <div className='grid gap-4 md:grid-cols-3'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Potential of account turning NPA</FormLabel>
                      <FormControl>
                        <select
                          name={field.name}
                          value={field.value ?? ''}
            ...
            <CardContent className='space-y-4'>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Signature &amp; Seal (notes / reference)
                    </FormLabel>
                    <FormControl>
                      <Textarea
                        rows={2}
          ...
          <div className='flex justify-end'>
            ...
            >
              {isSubmitting || saveMrbReportMutation.isPending
                ? 'Saving…'
                : 'Save'}
            </Button>
          </div>
