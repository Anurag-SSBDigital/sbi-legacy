...
export const Route = createFileRoute(
  '/_authenticated/stock-audit/$accountId/report/$assignmentIdUGB'
)({
  component: RouteComponent,
})

function RouteComponent() {
  const { accountId, assignmentIdUGB } = Route.useParams()
  const navigate = useNavigate()

  // Borrower details for auto-fill (acctNo, name, address)
  const { data: borrowerDetail, isLoading: isLoadingBorrower } = $api.useQuery(
    'get',
    '/account/getAccountDetail',
    {
      params: {
        query: {
          acctNm: accountId,
          assignId: Number(assignmentIdUGB),
        },
      },
    }
  )
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      // Annexure II A – Stock Audit Report Header
      branchVisitDate: '',
      unitVisitDate: '',
      ...
      // Annexure II B – Position of Account
      facilities: [],
      totalFundBasedLimit: '',
      ...
      // 14. Other Features & Observations
  ...
  const onSubmit = (data) => {
    submitReportMutation.mutate({
      body: {
        ...
        bankCode: 'UGB',
        accountId,
        assignmentId: Number(assignmentIdUGB),
      },
    })
  }
          ...
          >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder='Borrower / Firm Name'
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <select
                            className='border-input bg-background text-foreground ring-offset-background focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm shadow-sm transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50'
                            value={field.value || ''}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Name of Person who Inspected the Account
                        </FormLabel>
                        <FormControl>
                          <Input {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder='e.g. 10.01.2025 to 12.01.2025'
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder='Standard / SMA / NPA etc.'
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          If Short Renewal – Validity Period
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder='e.g. upto 30.06.2025'
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder='Sole / Consortium / Multiple etc.'
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
            ...
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='flex flex-col gap-1 border-b'>
                <CardTitle className='text-xl'>
                  Position of Account as on (Rs. in Lacs) – Annexure II B
                </CardTitle>
                <p className='text-muted-foreground text-xs'>
                  Capture Fund Based / Non-Fund Based facilities with limits,
                  securities, DP, O/s, Overdues & ROI.
                </p>
              </CardHeader>
            ...
            {/* ===================== Annexure II C – Branch Inspection: T&C + Docs ===================== */}
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  Inspection at Branch – Terms & Conditions / Documentation
                  (Annexure II C – A & Docs)
                </CardTitle>
              </CardHeader>
              <CardContent className='space-y-6 pt-6'>
                {/* Terms & Conditions */}
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Proper Documentation Obtained
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          If NOT, Give Details of Deficiencies
                        </FormLabel>
                        <FormControl>
                          <Textarea rows={3} {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Date of Last Debit Balance Confirmation
                        </FormLabel>
                        <FormControl>
                          <Input type='date' {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Documents Vetted by Advocate / Legal Dept as
                          per Norms
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Adequate Stamps Affixed (Docs / Equitable Mortgage
                          etc.)
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Details of Registration of Charge (including
            ...
            {/* ===================== Operations / Performance of Account ===================== */}
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  Operations / Performance of the Account at Branch
                </CardTitle>
              </CardHeader>
              <CardContent className='space-y-6 pt-6'>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Sales are Routed through the Account
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Cash Withdrawals are Regularly Allowed
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Reasons for Allowing Cash Withdrawals (if any)
                      </FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Any Transaction Indicating Diversion of Funds (Based on
                        Random Checking)
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-4'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          No. of Cheques Returned for Financial Reasons
                        </FormLabel>
                        <FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Credit / Debit Summations in Tune with Sales
                          Projections?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Interest Serviced within 10 days of Due Date?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Remarks on Utilisation Pattern / Summations vs
                        Projections
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          No. of Times Account Remained Overdrawn
                        </FormLabel>
                        <FormControl>
                          <Input type='number' {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Excesses Allowed – Continuously / Occasionally
                          / Rarely
                        </FormLabel>
                        <FormControl>
                          <select
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Excesses Have Been Confirmed by Competent
                          Authority
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether PC is Adjusted by Application out of Export
                          Proceeds
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Bills (Foreign / Inland) Realized as per Tenor
                          / Terms
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Buyer-wise ECGC Coverage Obtained as per Sanction
                          Terms
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Details of Overdue Bills – Inland / Foreign
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Comments on ECGC Coverage / Exceptions
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Interest is Being Serviced Regularly
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Date up to which Interest is Serviced
                        </FormLabel>
                        <FormControl>
                          <Input type='date' {...field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        No. of LCs Devolved, Amount, Dates, Reasons & Recovery
                        Steps
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Guarantees Invoked – Number, Date, Amount, Reasons &
                        Recovery
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Critical Amount of Interest / Charges Due
                        </FormLabel>
                        <FormControl>
                          <Input type='number' step='0.01' {...field} />
                        </FormControl>
            ...
            {/* ===================== Submission of Statements & Insurance ===================== */}
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  Submission of Statements & Insurance
              ...
              <CardContent className='space-y-6 pt-6'>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Stock Statements Received Regularly?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          DP Being Calculated / DP Register Maintained?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Remarks on DP Calculation / Register
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-4'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          FFR Statements Received Regularly?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Comments on Insurance Adequacy & Discrepancies (Address,
                        Goods, Inadequacy, etc.)
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
            ...
            {/* ===================== Unit Visit, Capacity, Stock & DP ===================== */}
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  Unit Visit, Production Capacity, Stock & Drawing Power
                </CardTitle>
              </CardHeader>
              <CardContent className='space-y-6 pt-6'>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Party&apos;s Name Board Prominently Displayed?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                        </FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Method of Valuation – Raw Materials
                        </FormLabel>
                        <FormControl>
                          <Input
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Method of Valuation – Stock in Process
                        </FormLabel>
                        <FormControl>
                          <Input {...field} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Method of Valuation – Finished Goods
                        </FormLabel>
                        <FormControl>
                          <Input {...field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Comments on Discrepancies in Inventories & Impact of
                        Change in Valuation Method (if any)
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Date as on which Hypothecated Stock Position is
                          Reported
                        </FormLabel>
                        <FormControl>
                          <Input type='date' {...field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Stock Position of Hypothecated Stock (Summary as on
                          above date)
                        </FormLabel>
                        <FormControl>
                          <Textarea rows={2} {...field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Date of Stock Statement (for which Physical Stock
                          Reconciled)
                        </FormLabel>
                        <FormControl>
                          <Input type='date' {...field} />
                ...
                {/* Reconciliation – Physical Stock vs Stock Statement */}
                <Card className='border border-dashed'>
                  <CardHeader>
                    <CardTitle className='text-base'>
                      Physical Inventory & Reconciliation (Rs. in Lacs)
                    </CardTitle>
                  </CardHeader>
                    ...
                    <div className='grid grid-cols-1 gap-4 md:grid-cols-4'>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              Add Purchases (Between Stock Statement &
                              Inspection)
                            </FormLabel>
                            <FormControl>
                              <Input type='number' step='0.01' {...field} />
                    ...
                    <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              Value of Stocks as per Reconciliation (Ref.
                              Closing Stock)
                            </FormLabel>
                            <FormControl>
                              <Input type='number' step='0.01' {...field} />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              Less Unpaid Stocks (including DA / LC / under
                              Bills)
                            </FormLabel>
                            <FormControl>
                              <Input type='number' step='0.01' {...field} />
              ...
              <CardContent className='space-y-6 pt-6'>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Age-wise & Party-wise Breakup Verified with Invoices /
                          Sales Register?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Average Time for Realisation of Book Debts
                        </FormLabel>
                        <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Comparison with Past Trend / Trade Trend & Reasons for
                        Variation
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Overall Observation on Quality of Book Debts
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Value of Stocks as per Books Matches Actual Inventory
                          Holdings?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Finished Goods Include Returned / Old / Obsolete /
                          Non-salable Items?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Differences between Books and Physical Stocks – Analysis
                        / Impact
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Reasons for Non-adherence to Inventory Holding Levels
                        (if any)
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Comments on Inclusion of Old Batches / Non-salable Stock
                        & DP Acceptability
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Whether Company is Following the Correct Stocking
                          Pattern?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Proper Internal Control Exists for Verification of
                          Stocks?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Proper Books of Account Maintained (including Stock
                          Register)?
                        </FormLabel>
                        <FormControl>
                          <YesNoNaSelect field={field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Comments on Books of Accounts / Internal Controls
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
            ...
            {/* ===================== Other Features & Overall Observations ===================== */}
            <Card className='bg-card/50 ring-border rounded-2xl border shadow-xl ring-1'>
              <CardHeader className='border-b'>
                <CardTitle className='text-xl'>
                  Other Features, Statutory Compliance & Overall Observations
                </CardTitle>
              </CardHeader>
              <CardContent className='space-y-6 pt-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Compliance to Statutory Obligations (Excise, VAT / GST,
                        Power, Labour etc.) – Comparative Comments
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Compliance to Pollution Control Norms
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Whether Factory has been Closed due to Lockout / Strike
                        – Details
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Safety & Security Measures, Storage of Goods,
                        Accessibility
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Whether Branch Officers Conducted Inspection Regularly –
                        Dates / Irregularities / Deviations
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={2} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Irregularities in Last RBI / Statutory / Internal /
                        Concurrent Audit re: Stocks & Book Debts – Action Taken
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Value of Sundry Debtors as per Books vs Stock Statement
                        (31st March etc.) – Differences & Comments
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Details of Other Banks / Facilities (if any)
                        </FormLabel>
                        <FormControl>
                          <Textarea rows={2} {...field} />
                        </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Reasons, if any, Indicating Continuation of Relationship
                        may not be Beneficial – Comments
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Suggestions for Risk Mitigation for the Bank
                      </FormLabel>
                      <FormControl>
                        <Textarea rows={3} {...field} />
                      </FormControl>
              ...
              <CardContent className='space-y-6 pt-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Enclosures (List of Annexures / Statements)
                      </FormLabel>
                      <FormControl>
                        <Textarea
                          rows={3}
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                  ...
                  />
                  <div className='text-muted-foreground flex flex-col justify-end text-sm'>
                    <span className='font-medium'>
                      Seal & Signature of Stock Auditor / CA Firm
                    </span>
                    <span className='text-xs'>
                      (Captured outside this form as physical / digital
                      signature)
                    </span>
                  </div>
                </div>
            ...
            {/* ===================== Sticky Actions ===================== */}
            <div className='bg-background/80 supports-[backdrop-filter]:bg-background/60 sticky bottom-0 z-10 -mx-6 border-t px-6 py-4 backdrop-blur'>
...
const StockAuditFormSkeleton = () => {
  return (
    <MainWrapper>
      <div className='w/full mx-auto max-w-7xl space-y-10 px-6'>
...
function YesNoNaSelect({ field }: { field }) {
  return (
    <select
      name={field.name}
                            ...
                            if (column.type === 'select' && column.options) {
                              return (
                                <select
                                  ...
                                  onBlur={field.onBlur}
                                  className='border-input bg-background text-foreground ring-offset-background focus-visible:ring-ring flex h-9 w-full rounded-md border px-2 py-1 text-xs shadow-sm transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50'
                                >
                                  <option value=''>Select</option>
