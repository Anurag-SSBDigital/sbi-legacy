...
// --- Route Definition ---
export const Route = createFileRoute('/_authenticated/ots/tasks/')({
    ...
    <MainWrapper>
      <div className='bg-muted/10 flex h-full flex-col space-y-2 p-2'>
        ...
        <div className='flex items-center justify-between'>
          <div>
            <h2 className='text-3xl font-bold tracking-tight'>OTS Tasks</h2>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className='sm:max-w-[500px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete the actions required for this OTS stage.
          </DialogDescription>
        </DialogHeader>
