...
export default function SignInPage() {
  ...
  return (
    <div className='relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#f7fafc] via-white to-[#eef6ff] dark:from-[#0b1220] dark:via-[#0f172a] dark:to-[#0b1220]'>
      ...
      {/* Logo and Welcome */}
      <div className='z-10 mb-8 flex flex-col items-center px-4 text-center'>
        <div className='relative h-45 w-auto'>
          <img
            src={ViteLogo}
            alt='SSBD Logo'
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder='name@example.com'
                      {...field}
                      className='h-11 rounded-xl border-slate-300/70 bg-white/80 placeholder:text-slate-400 focus-visible:ring-[color:var(--ring)] dark:border-slate-700 dark:bg-slate-800/90 dark:text-white'
                      autoComplete='username'
                      aria-label='Username'
                    />
                  </FormControl>
