...
// --- Route Definition ---
export const Route = createFileRoute('/_authenticated/recalled-assets/tasks/')({
...
function RouteComponent() {
  ...
  const { data: dashboard, isLoading: dashboardLoading } = $api.useQuery(
    'get',
    '/api/recalledassets/user/dashboard',
    {
  ...
  const handleConfirmAction = () => {
    ...
    if (selectedTask?.taskId) {
      navigate({
        to: '/recalled-assets/tasks/$taskId',
  ...
  return (
    <MainWrapper>
      <div className='bg-muted/10 flex h-full flex-col space-y-2 p-2'>
        ...
        <div className='grid gap-6 mt-4 md:grid-cols-7 lg:grid-cols-7'>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className='sm:max-w-[500px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete the actions required for this Recalled Assets stage.
          </DialogDescription>
        </DialogHeader>
