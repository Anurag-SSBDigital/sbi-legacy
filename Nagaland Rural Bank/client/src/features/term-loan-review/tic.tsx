...
export default function TGBLoanReviewForm() {
  ...
  const prefilledValues = useMemo<FormValues>(() => {
    ...
    return {
      ...
      genericAccountNo: customer?.acctNo ?? accountId ?? '',
  ...
  const onSubmit = async (values: FormValues) => {
    const payload = { ...values, bankCode: 'TGB' }
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-10'>
              ...
              <fieldset disabled={viewOnly} className='space-y-8'>
                ...
                >
                  ...
                  <div className='mt-4 grid grid-cols-1 gap-4 md:grid-cols-4'>
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Generic Account No</FormLabel>
                          <FormControl>
                            <Input {...field} />
                          </FormControl>
                          <FormMessage />
                ...
                <FormSection
                  ...
                  description='Read-only system fields for audit trail.'
                >
                  <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                    <FormField
                      control={form.control}
