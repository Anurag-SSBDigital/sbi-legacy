...
const FormSchema = z.object({
  ...
  // ===================================
  // NEW: Annexure-1 Fields
  // ===================================
  address: z.string().optional(),

  // ===================================
  // NEW: Annexure-2 Fields
  // ===================================
  nrbSegment: z.string().optional(),
  nrbProprietorPartnerPromoterName: z.string().optional(),
  panNumber: z.string().optional(),
  nrbProductCode: z.string().optional(),
  nrbProductName: z.string().optional(),
  nrbWhetherLumpsumPayment: z.enum(['YES', 'NO']).optional(),
  nrbLumpsumPaymentDate: z.string().optional(),
  nrbMobileNo: z.string().optional(),
  nrbProductInterestRate: z.string().optional(),
  aadhaarNumber: z.string().optional(),
  scheme: z.string().optional(),

  // Annexure-2 Financials
  nrbOutstandingAsOnCutoff: z.string().optional(),
  nrbPriorPeriodInterestReversedUptoNpa: z.string().optional(),
  nrbAccruedUnappliedInterestUptoNpa: z.string().optional(),
  nrbAmountCreditedBeforeCutoff: z.string().optional(),
  nrbLiquidSecuritySubsidiesNotRealized: z.string().optional(),
  nrbPresentOutstanding: z.string().optional(),

  nrbInterestFromNpaFromDate: z.string().optional(),
  nrbInterestFromNpaToDate: z.string().optional(),
  nrbInterestFromNpaAmount: z.string().optional(),

  nrbLegalOutOfPocketActualsNotDebited: z.string().optional(),
  nrbTotalDues: z.string().optional(),

  nrbSecuredPortionAmount: z.string().optional(),
  nrbUnsecuredPortionAmount: z.string().optional(),

  nrbSanctionedEligibleOtsAmount: z.string().optional(),
  nrbRecoveryAfterCutoffToLaunchDate: z.string().optional(),
  nrbAmountToBePaid: z.string().optional(),

  sacrificeAmount: z.string().optional(),
  nrbCircularDate: z.string().optional(),
  ...
  const onSubmit = (values: FormValues) => {
    ...
    createOTSMutation.mutate({
      ...
      body: {
        ...
        nrbSegment: values.nrbSegment || undefined,
        nrbProprietorPartnerPromoterName:
          values.nrbProprietorPartnerPromoterName || undefined,
        panNumber: values.panNumber || undefined,
        nrbProductCode: values.nrbProductCode || undefined,
        nrbProductName: values.nrbProductName || undefined,
        nrbWhetherLumpsumPayment: values.nrbWhetherLumpsumPayment === 'YES',
        nrbLumpsumPaymentDate: values.nrbLumpsumPaymentDate || undefined,
        nrbMobileNo: values.nrbMobileNo || undefined,
        nrbProductInterestRate: toNumberOrUndefined(
          values.nrbProductInterestRate
        ),
        aadhaarNumber: values.aadhaarNumber || undefined,
        scheme: values.scheme || undefined,
        nrbCircularDate: values.nrbCircularDate || undefined,

        // Financials (Annexure 2)
        nrbOutstandingAsOnCutoff: toNumberOrUndefined(
          values.nrbOutstandingAsOnCutoff
        ),
        nrbPriorPeriodInterestReversedUptoNpa: toNumberOrUndefined(
          values.nrbPriorPeriodInterestReversedUptoNpa
        ),
        nrbAccruedUnappliedInterestUptoNpa: toNumberOrUndefined(
          values.nrbAccruedUnappliedInterestUptoNpa
        ),
        nrbAmountCreditedBeforeCutoff: toNumberOrUndefined(
          values.nrbAmountCreditedBeforeCutoff
        ),
        nrbLiquidSecuritySubsidiesNotRealized: toNumberOrUndefined(
          values.nrbLiquidSecuritySubsidiesNotRealized
        ),
        nrbPresentOutstanding: toNumberOrUndefined(
          values.nrbPresentOutstanding
        ),
        nrbInterestFromNpaFromDate:
          values.nrbInterestFromNpaFromDate || undefined,
        nrbInterestFromNpaToDate: values.nrbInterestFromNpaToDate || undefined,
        nrbInterestFromNpaAmount: toNumberOrUndefined(
          values.nrbInterestFromNpaAmount
        ),
        nrbLegalOutOfPocketActualsNotDebited: toNumberOrUndefined(
          values.nrbLegalOutOfPocketActualsNotDebited
        ),
        nrbTotalDues: toNumberOrUndefined(values.nrbTotalDues),
        nrbSecuredPortionAmount: toNumberOrUndefined(
          values.nrbSecuredPortionAmount
        ),
        nrbUnsecuredPortionAmount: toNumberOrUndefined(
          values.nrbUnsecuredPortionAmount
        ),
        nrbSanctionedEligibleOtsAmount: toNumberOrUndefined(
          values.nrbSanctionedEligibleOtsAmount
        ),
        nrbRecoveryAfterCutoffToLaunchDate: toNumberOrUndefined(
          values.nrbRecoveryAfterCutoffToLaunchDate
        ),
        nrbAmountToBePaid: toNumberOrUndefined(values.nrbAmountToBePaid),
        sacrificeAmount: toNumberOrUndefined(values.sacrificeAmount),

        // --- Existing Annexure 3 Fields ---
  ...
  return (
    <>
      ...
      <div className='p-4'>
        <div className='flex items-center justify-between'>
          <div>
            <h1 className='text-3xl font-bold tracking-tight'>
              Annexure — Settlement of dues under OTS
            </h1>
        ...
        <Card className='mb-6'>
          <CardHeader>
            <CardTitle>Annexure-I</CardTitle>
            <CardDescription>General Details</CardDescription>
          </CardHeader>
          <CardContent className='space-y-5'>
            <RowField no='1' label='Name of Borrower' htmlFor='borrowerNameA1'>
              <Input
                id='borrowerNameA1'
            ...
            <RowField no='2' label='Address' htmlFor='address'>
              <Textarea
                id='address'
                placeholder='Address'
            ...
            <RowField no='3' label='Loan Account No.' htmlFor='loanAccountNoA1'>
              <Input
                id='loanAccountNoA1'
        ...
        {/* ========================================================= */}
        {/* NEW: Annexure-II Card */}
        {/* ========================================================= */}
        <Card className='mb-6'>
          <CardHeader>
            <CardTitle>Annexure-II</CardTitle>
            <CardDescription>Detailed Proposal Information</CardDescription>
          </CardHeader>
          <CardContent className='space-y-5'>
            {/* Row 1: Branch & Segment */}
            <RowField no='1' label='Branch Name' htmlFor='branchNameA2'>
              <Input
                id='branchNameA2'
            ...
            <RowField no='2' label='Segment' htmlFor='nrbSegment'>
              <Input
                id='nrbSegment'
                placeholder='MSME / Agri / etc.'
                {...form.register('nrbSegment')}
              />
            </RowField>

            {/* Row 2: Proprietor & PAN */}
            <RowField
              no='3'
              label='Proprietor/Partner/Promoter Name'
              htmlFor='nrbProprietorPartnerPromoterName'
            >
              <Input
                id='nrbProprietorPartnerPromoterName'
                placeholder='Name'
                {...form.register('nrbProprietorPartnerPromoterName')}
              />
            </RowField>
            <RowField no='4' label='PAN Number' htmlFor='panNumber'>
              <Input
                id='panNumber'
            ...
            <RowField no='5' label='Product Details' htmlFor='nrbProductCode'>
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Input
                  id='nrbProductCode'
                  placeholder='Product Code'
                  {...form.register('nrbProductCode')}
                />
                <Input
                  id='nrbProductName'
                  placeholder='Product Name'
                  {...form.register('nrbProductName')}
                />
              </div>
            </RowField>

            {/* Row 4: Lumpsum Payment */}
            <RowField
              no='6'
              label='Whether Lumpsum Payment?'
              htmlFor='nrbWhetherLumpsumPayment'
            >
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Controller
                  control={form.control}
                  name='nrbWhetherLumpsumPayment'
                  render={({ field }) => (
                ...
                <Input
                  type='date'
                  placeholder='Date'
                  {...form.register('nrbLumpsumPaymentDate')}
                />
              </div>
            </RowField>

            {/* Row 5: Mobile & Interest */}
            <RowField no='7' label='Contact & Interest' htmlFor='nrbMobileNo'>
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Input
                  id='nrbMobileNo'
                  placeholder='Mobile No'
                  {...form.register('nrbMobileNo')}
                />
                <Input
                  id='nrbProductInterestRate'
                  placeholder='Interest Rate %'
                  inputMode='decimal'
                  {...form.register('nrbProductInterestRate')}
                />
              </div>
            </RowField>

            {/* Row 6: Aadhaar & Scheme */}
            <RowField no='8' label='Aadhaar & Scheme' htmlFor='aadhaarNumber'>
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Input
                  id='aadhaarNumber'
                ...
                <Input
                  ...
                  {...form.register('scheme')}
                />
              </div>
            </RowField>

            <Separator className='my-2' />
            <div className='text-sm font-semibold'>Financial Details (NRB)</div>

            <RowField
              no='9'
              label='Outstanding as on Cutoff (₹)'
              htmlFor='nrbOutstandingAsOnCutoff'
            >
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbOutstandingAsOnCutoff')}
              />
            </RowField>

            <RowField
              no='10'
              label='Interest Info (Reversed / Accrued) (₹)'
              htmlFor='nrbPriorPeriodInterestReversedUptoNpa'
            >
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Input
                  placeholder='Prior Period Int. Reversed'
                  inputMode='decimal'
                  {...form.register('nrbPriorPeriodInterestReversedUptoNpa')}
                />
                <Input
                  placeholder='Accrued Unapplied Int.'
                  inputMode='decimal'
                  {...form.register('nrbAccruedUnappliedInterestUptoNpa')}
                />
              </div>
            </RowField>
            ...
            <RowField
              no='11'
              label='Amount Credited Before Cutoff (₹)'
              htmlFor='nrbAmountCreditedBeforeCutoff'
            >
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbAmountCreditedBeforeCutoff')}
              />
            </RowField>

            <RowField
              no='12'
              label='Liquid Security / Subsidies Not Realized (₹)'
              htmlFor='nrbLiquidSecuritySubsidiesNotRealized'
            >
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbLiquidSecuritySubsidiesNotRealized')}
              />
            </RowField>
            ...
            <RowField
              ...
              htmlFor='nrbPresentOutstanding'
            >
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbPresentOutstanding')}
              />
            </RowField>

            <RowField
              no='14'
              label='Interest from NPA Date'
              htmlFor='nrbInterestFromNpaFromDate'
            >
              <div className='grid grid-cols-1 gap-3 md:grid-cols-3'>
                <div className='space-y-1'>
                  ...
                  <Input
                    type='date'
                    {...form.register('nrbInterestFromNpaFromDate')}
                  />
                </div>
                <div className='space-y-1'>
                  ...
                  <Input
                    type='date'
                    {...form.register('nrbInterestFromNpaToDate')}
                  />
                </div>
                <div className='space-y-1'>
                  ...
                  <Input
                    inputMode='decimal'
                    placeholder='0'
                    {...form.register('nrbInterestFromNpaAmount')}
                  />
                </div>
              </div>
            </RowField>
            ...
            <RowField
              no='15'
              label='Legal / Out of Pocket Expenses (₹)'
              htmlFor='nrbLegalOutOfPocketActualsNotDebited'
            >
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbLegalOutOfPocketActualsNotDebited')}
              />
            </RowField>

            <RowField no='16' label='Total Dues (NRB) (₹)' htmlFor='nrbTotalDues'>
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbTotalDues')}
              />
            </RowField>

            <RowField
              no='17'
              label='Secured / Unsecured Portion (₹)'
              htmlFor='nrbSecuredPortionAmount'
            >
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Input
                  placeholder='Secured Amount'
                  inputMode='decimal'
                  {...form.register('nrbSecuredPortionAmount')}
                />
                <Input
                  placeholder='Unsecured Amount'
                  inputMode='decimal'
                  {...form.register('nrbUnsecuredPortionAmount')}
                />
              </div>
            </RowField>
            ...
            <RowField
              no='18'
              label='OTS Offer Details (₹)'
              htmlFor='nrbSanctionedEligibleOtsAmount'
            >
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                <Input
                  placeholder='Sanctioned Eligible OTS Amt'
                  inputMode='decimal'
                  {...form.register('nrbSanctionedEligibleOtsAmount')}
                />
                <Input
                  placeholder='Recovery after Cutoff'
                  inputMode='decimal'
                  {...form.register('nrbRecoveryAfterCutoffToLaunchDate')}
                />
              </div>
            </RowField>
            ...
            <RowField
              no='19'
              label='Net Amount to be Paid (₹)'
              htmlFor='nrbAmountToBePaid'
            >
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('nrbAmountToBePaid')}
              />
            </RowField>

            <RowField no='20' label='Sacrifice Amount (₹)' htmlFor='sacrificeAmount'>
              <Input
                inputMode='decimal'
                placeholder='0'
                {...form.register('sacrificeAmount')}
              />
            </RowField>

            <RowField no='21' label='Circular Date' htmlFor='nrbCircularDate'>
              <Input type='date' {...form.register('nrbCircularDate')} />
            </RowField>
          </CardContent>
        </Card>
