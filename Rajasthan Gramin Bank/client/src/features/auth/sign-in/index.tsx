...
//         <div className='relative mt-8 h-35 w-90'>
...
export default function SignInPage() {
  ...
  return (
    <div className='relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#f7fafc] via-white to-[#eef6ff] dark:from-[#0b1220] dark:via-[#0f172a] dark:to-[#0b1220]'>
      {/* doodle layer */}
      <svg
        aria-hidden
        className='pointer-events-none absolute inset-0 h-full w-full opacity-30 dark:opacity-20'
        viewBox='0 0 1440 900'
        preserveAspectRatio='none'
      >
        <g
          ...
          strokeLinecap='round'
          strokeLinejoin='round'
          className='text-slate-700/40 dark:text-white/40'
        >
          <path
            d='M40 70 C 120 30, 200 120, 280 80'
            strokeDasharray='420'
      ...
      <div className='z-10 flex w-full max-w-md flex-col items-center px-6 text-center'>
        ...
        <div className='relative mb-6 flex flex-col items-center'>
          <img src={ViteLogo} alt='SSBD Logo' className='h-24 w-auto' />
          <h1 className='mt-3 bg-[linear-gradient(90deg,var(--primary),color-mix(in_oklab,var(--primary)_60%,white_40%))] bg-clip-text text-4xl font-extrabold text-transparent'>
            EWS-CMS
          </h1>
        ...
        {/* form card */}
        <div className='w-full rounded-3xl border border-slate-200/70 bg-white/90 p-6 shadow-[0_24px_80px_-20px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-transform duration-300 hover:scale-[1.01] dark:border-white/10 dark:bg-slate-900/80'>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
              <FormField
                control={form.control}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder='name@example.com'
                        {...field}
                        className='h-11 rounded-xl border-slate-300/70 bg-white/85 text-slate-900 placeholder:text-slate-400 focus-visible:ring-[color:var(--ring)] dark:border-white/10 dark:bg-slate-800/85 dark:text-white'
                        autoComplete='username'
                        aria-label='Username'
                      />
                    </FormControl>
              ...
              <Button
                type='submit'
                className='relative mt-2 h-11 w-full rounded-xl bg-[color:var(--primary)] text-[15px] font-bold text-white shadow-lg shadow-[rgba(0,147,221,0.25)] focus-visible:ring-2 focus-visible:ring-[color:var(--ring)] focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-70'
                disabled={isLoading}
              >
                <span className='relative z-10'>
                  {isLoading ? 'Logging in…' : 'Login'}
