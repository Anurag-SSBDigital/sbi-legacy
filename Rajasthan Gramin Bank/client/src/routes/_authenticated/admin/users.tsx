        ...
        <div className='space-y-4 p-6 pt-4'>
          ...
          <div className='flex flex-wrap items-center gap-2'>
            ...
            {file?.name ? (
              ...
              <span className='text-xs text-(--color-muted-foreground)'>No file selected</span>
            )}
          </div>
          ...
          <div className='grid grid-cols-2 gap-3 sm:grid-cols-4'>
            <div className='rounded-xl border bg-(--color-card) p-3 shadow-sm'>
              <div className='text-[11px] text-(--color-muted-foreground)'>Valid Rows</div>
              <div className='text-xl font-semibold'>{rows.length}</div>
            </div>
            <div className='rounded-xl border bg-(--color-card) p-3 shadow-sm'>
              <div className='text-[11px] text-(--color-muted-foreground)'>Invalid Rows</div>
              <div className='text-xl font-semibold'>{failures.length}</div>
            </div>
            <div className='rounded-xl border bg-(--color-card) p-3 shadow-sm'>
              <div className='text-[11px] text-(--color-muted-foreground)'>Uploaded</div>
              <div className='text-xl font-semibold'>{sent}</div>
            </div>
            <div className='rounded-xl border bg-(--color-card) p-3 shadow-sm'>
              <div className='text-[11px] text-(--color-muted-foreground)'>Success / Failed</div>
