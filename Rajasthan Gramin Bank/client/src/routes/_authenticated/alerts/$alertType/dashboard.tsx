...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className='pointer-events-none absolute -right-10 -top-10 h-28 w-28 rounded-full blur-3xl opacity-30'
        style={{
...
function RouteComponent() {
  ...
  const { data: apiData, isLoading, error } = $api.useQuery(
    'get',
    '/alert/resolutions/dashboard',
    {
      params: {
        query: {
  ...
  const pending =
    Number(
      ...
      'PENDING_APPROVAL' as keyof NonNullable<typeof dashboardData>['statusCounts']
      ] ?? 0
    ) || 0
  const approved =
    Number(
  ...
  return (
    ...
    >
      ...
      <div className='pointer-events-none fixed inset-0 -z-10 overflow-hidden'>
        <div
          className='absolute -top-40 -right-40 h-[520px] w-[520px] rounded-full blur-[120px] opacity-40 dark:opacity-25'
          style={{
            background:
        ...
        />
        <div
          className='absolute -bottom-40 -left-40 h-[520px] w-[520px] rounded-full blur-[120px] opacity-40 dark:opacity-25'
          style={{
            background:
      ...
      <div className='mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3'>
        <StatCard title='Total Alerts' value={totalAlerts} icon={AreaChart} tone='primary' />
        <StatCard
      ...
      <div className='mb-8 grid grid-cols-1 gap-6 lg:grid-cols-5'>
        {/* Pie */}
        <Card className='lg:col-span-2 border bg-[var(--color-card)] shadow-sm'>
        ...
        <Card className='lg:col-span-3 border bg-[var(--color-card)] shadow-sm'>
          <CardHeader className='border-b'>
            <CardTitle className='flex items-center gap-2 text-base font-semibold'>
                          ...
                          <div className='flex items-center justify-between gap-3'>
                            <div className='flex min-w-0 items-center gap-3'>
                              ...
                              <div className='min-w-0'>
                                <div className='truncate text-sm font-medium' title={d.masterDescription}>
                                  {d.masterDescription}
                                </div>
