...
import { LayoutDashboardIcon, List, WorkflowIcon } from 'lucide-react'
  ...
  navGroups: [
    ...
    /* ───────────────── ADMIN / MASTERS ───────────────── */
    {
      ...
      items: [
        ...
        { title: 'Workflow', url: '/admin/workflow', icon: WorkflowIcon },
        {
    ...
    /* ───────────────── CREDIT & RECOVERY WORKFLOWS ───────────────── */
    {
      ...
      userAccess: ['admin', 'superadmin', 'user'],
      items: [
        workflowGroup('SARFAESI', '/sarfaesi'),
        workflowGroup('OTS / COMPROMISE', '/ots'),
        workflowGroup('AUCA', '/auca'),
        workflowGroup('RECALLED ASSETS', '/recalled-assets'),
        workflowGroup('P. L. REVIEW', '/problem-loan-review'),
...
function workflowGroup(title: string, base: string) {
  return {
    title,
    icon: WorkflowIcon, // ✅ group icon indicates “process/workflow”
    items: [
      { title: 'Accounts', url: base, icon: IconListDetails },
      { title: 'Eligible', url: `${base}/eligible`, icon: IconChecklist },
      { title: 'My Tasks', url: `${base}/tasks`, icon: IconClipboardSearch },
    ],
  }
}
